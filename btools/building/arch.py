...
def create_arch(bm, top_edges, frame_faces, arch_prop, frame_thickness, xyz):
    ...
    upper_arc = filter_geom(arc_edge(bm, arc_edges[0], resolution, height, xyz, function)["geom_split"], BMEdge)
...
def pane_arch_face(bm, face, prop):
    bmesh.ops.inset_individual(bm, faces=[face], thickness=prop.pane_margin * 0.75, use_even_offset=True)
